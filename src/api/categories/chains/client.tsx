...
export function useGetProtocolsVolumeByChain() {
  const chain = 'Sonic';
	return useQuery({
...
export function useGetFeesAndRevenueChartDataByChain() {
	const chain = 'Sonic';
	return useQuery({
...
export function useGetProtocolsFeesAndRevenueByChain() {
  const chain = 'Sonic';
	return useQuery({
...
export const useGetItemOverviewByChain = (item?: string) => {
	const chain = 'Sonic';
	return useQuery({
