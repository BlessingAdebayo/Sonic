...
// 					: null,
// 			methodologyUrls: {
// 				tvl: protocolData.module ? `https://github.com//-Adapters/tree/main/projects/${protocolData.module}` : null,
...
// 					? `https://github.com//-Adapters/blob/main/projects/treasury/${protocolData.treasury}`
// 					: null,
// 				stablecoins: protocolData.stablecoins
// 					? protocolData.stablecoins
// 							.map(
// 								(name) =>
// 									`${name}$https://github.com//peggedassets-server/blob/master/src/adapters/peggedAssets/${name}/index.ts`
// 							)
// 							.join(',')
// 					: null
// 			},
