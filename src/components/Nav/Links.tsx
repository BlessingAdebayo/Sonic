...
export const defaultToolsAndFooterLinks = {
	tools: [
		{
			name: 'Sonic Analytics Extension',
...
export const navLinks: ILinks = {
	DeFi: {
		main: [
			...
			{ name: 'Bridged TVL', path: '/bridged/Sonic' },
	...
	Yields: {
		...
		tools: [
			...
			{ name: 'List your protocol', path: 'https://github.com/Sonic Analytics/yield-server#readme', external: true },
			{
				name: 'Download Data',
		...
		footer: [
			{ name: 'About Sonic Analytics', path: '#' },
			{
				name: 'Twitter',
				path: '#',
				external: true
...
export const linksWithNoSubMenu = [
	...
	{ name: 'Governance', url: '/governance/sonic' },
	{ name: 'CEX Transparency', url: '/cexs' },
	{ name: 'Sonic Analytics Swap', url: 'https://swap.defillama.com/', external: true },
