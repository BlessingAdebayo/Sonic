...
export function ChainContainer({
	...
	const chartOptions = [
		{ id: 'tvl', name: 'TVL', isVisible: true },
		{ id: 'volume', name: 'Volume', isVisible: volumeData?.totalVolume24h ? true : false },
		{ id: 'fees', name: 'Fees', isVisible: feesAndRevenueData?.totalFees24h ? true : false },
		{
			id: 'tvl',
			name: 'TVL',
			isVisible: true
	...
	return (
		<>
			<SEO cardName="Sonic" chain="Sonic" tvl={tvl as string} volumeChange={percentChange} />
