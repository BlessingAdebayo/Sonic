	...
	return (
		<div className="flex items-center justify-between gap-2 rounded-md p-[6px] w-[220px] bg-[var(--bg6)]">
			<button
				...
				className="flex items-center justify-center gap-1 text-sm whitespace-nowrap flex-nowrap p-[6px] rounded-md flex-1 bg-[var(--bg6)] data-[active=true]:bg-[#44d06f] data-[active=true]:text-white"
			>
