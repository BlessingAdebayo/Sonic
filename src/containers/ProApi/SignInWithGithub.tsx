...
const SignInWithGithub = () => {
		...
		return (
			<div>
				...
				<p className="text-sm text-center mt-3 text-[var(--text2)]">
					You are not a contributor. You need to contribute to the project to get free access to the premium API.
				</p>
			</div>
		)
	}
	...
	return (
		<div>
			...
			<p className="text-sm text-center mt-3 text-[var(--text2)]">
				contributors will have free 3 month access to premium API.
			</p>
		</div>
	)
}
