					...
					<div className="flex flex-col text-base w-full rounded-md p-4 bg-[var(--bg1)] gap-4">
						{isSubscribed ? (
							<button
								...
								className="shadow p-2 rounded-lg bg-[#44d06f] text-base"
							>
								Sign In
							</button>
						) : (
							<>
								{!wallet.isConnected ? (
									<button onClick={openConnectModal} className="shadow p-2 rounded-lg bg-[#44d06f] text-base">
										Connect Wallet
									</button>
								) : (
									<button onClick={() => startPayment()} className="shadow p-2 rounded-lg bg-[#44d06f] text-base">
										Subscribe
									</button>
								)}
								OR
									...
									<tr>
										...
										<th className="p-3 whitespace-nowrap border border-black/10 dark:border-white/10 bg-[var(--bg1)] text-[var(--text1)]">
											<span className="flex items-center gap-2">
												Github Contributor
												<QuestionHelper text="Only available to users who have contributed to  repos, lasts for 3 months" />
											</span>
										</th>
									</tr>
									<tr>
