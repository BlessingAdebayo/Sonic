	...
	return (
		<div className="mt-[120px] text-center flex flex-col justify-center items-center w-full max-w-[600px] mx-auto">
			...
			<div className="mt-4 grid gap-4">
				...
				<>
					<div>
						Upgrade now for advanced DeFi analytics and insights! With Pro, you'll get access to a customizable
						dashboard, multiple protocols view, and more.
					</div>
				</>
				{!wallet.isConnected ? (
					...
					<button onClick={onSignClick} className="shadow p-2 rounded-lg bg-[#44d06f] text-base">
						Sign In
					</button>
				)}
