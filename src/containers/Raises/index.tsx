...
const RaisesContainer = ({ raises, investors, rounds, sectors, chains, investorName }) => {
	...
	return (
		<Layout title={`Raises - `} defaultSEO>
			...
			<RaisesTable
				raises={filteredRaisesList.filter((r) => r.chain === 'Sonic')}
				downloadCsv={() => downloadCsv({ raises: filteredRaisesList.filter((r) => r.chain === 'Sonic') })}
			/>
		</Layout>
	)
}
