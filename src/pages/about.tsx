...
function AboutPage(props: any) {
	return (
		<Layout title=" - DeFi Dashboard" defaultSEO>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<p>
					is the largest TVL aggregator for DeFi (Decentralized Finance). Our data is fully{' '}
					<a
						className="text-[var(--blue)] hover:underline"
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com//-Adapters"
					>
						open-source
					</a>{' '}
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com//-Adapters/graphs/contributors"
					>
						contributors
					</a>{' '}
