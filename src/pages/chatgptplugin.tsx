...
function PluginPage() {
	return (
		<Layout title=" - ChatGPT Plugin" defaultSEO>
			<h1 className="text-2xl font-medium mt-2 -mb-5"> ChatGPT Plugin</h1>

			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				<h2 className="font-semibold text-lg">About</h2>
				<hr className="border-black/20 dark:border-white/20" />
				<p>
					is the most popular DeFi (Decentralized Finance) data aggregator. The ChatGPT plugin retrieves current and
					historical data on blockchains, DeFi applications and bridges.
				</p>
			</div>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<hr className="border-black/20 dark:border-white/20" />
				<p>The ChatGPT plugin does not sell user data. The plugin does not collect any identifying user data.</p>
				<p>
					The Plugin uses{' '}
