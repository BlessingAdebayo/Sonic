	...
	return (
		<Layout title="Press - " defaultSEO>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<p>
					is the largest data aggregator for DeFi (Decentralized Finance). Our data is fully open-source and maintained
					by a team of passionate individuals and contributors from thousands of protocols.
				</p>
				<p>
					As a comprehensive DeFi data analysis platform, provides data across a wide variety of fundamentals, including
					TVL, Fees, Revenue, Volume, Stablecoins, Governance, Unlocks, and Yields.
				</p>
				<p>
					’s vision is to aggregate the most accurate, transparent, and neutral data for all blockhains and
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<p> Data is free to use by anyone for press usage. Attribution is always appreciated.</p>
				<hr className="border-black/20 dark:border-white/20" />
				<p> is used across a large number of media organisations, governments, and financial institutions.</p>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<p>“” is one word, with a capital D and capital L The F is not capitalized.</p>
				<p>
					We always pair our name with the llama icon. We prefer to use the full name and icon when possible, but in
					situations where the association with is clear, the icon may be used on its own.
				</p>
				<p>The primary color used on is #2172E5.</p>
			</div>
		</Layout>
	)
}
